const quizData = [
  ...
  { question: "음료수 캔을 버리기 전에 어떤 처리를 해야 하나요?", answer: "헹굼" },
  { question: "플라스틱 뚜껑과 병은 어떻게 배출해야 하나요?", answer: "분리" },
  { question: "라벨이 붙은 플라스틱 용기는 어떻게 해야 하나요?", answer: "라벨 제거" },
  { question: "젖은 종이는 어떤 쓰레기로 분류되나요?", answer: "일반쓰레기" },
  { question: "우유팩은 종이와 같은 방법으로 재활용되나요?", answer: "아니오" },
  { question: "폐건전지는 어디에 버려야 하나요?", answer: "전용 수거함" },
  ...
  { question: "헌 옷은 어떤 방식으로 처리해야 하나요?", answer: "의류 수거함" },
  { question: "라벨 제거는 왜 중요한가요?", answer: "재활용 품질 향상" },
  { question: "음식물이 남은 종이류는 재활용 가능한가요?", answer: "불가능" },
  { question: "스프레이 캔은 어떻게 배출하나요?", answer: "구멍 없이 전용 수거" },
  { question: "유리병의 라벨은 꼭 제거해야 하나요?", answer: "가능하면 제거" },
  { question: "택배 박스는 어떤 쓰레기로 분류되나요?", answer: "종이류" },
  { question: "종이테이프가 붙은 상자는 어떻게 처리하나요?", answer: "테이프 제거 후 분리" },
  { question: "CD나 DVD는 어떤 쓰레기인가요?", answer: "일반쓰레기" },
  { question: "재활용이 안 되는 종이의 예는?", answer: "영수증" },
  { question: "배달용 플라스틱 용기는 어떻게 처리하나요?", answer: "헹구고 재활용" },
  { question: "치약 튜브는 어떤 쓰레기인가요?", answer: "일반쓰레기" },
  { question: "플라스틱 병에 붙은 스티커는 어떻게 해야 하나요?", answer: "제거" },
  { question: "종이호일은 어떤 쓰레기인가요?", answer: "일반쓰레기" },
  { question: "신문지는 어떤 재활용 품목인가요?", answer: "종이류" },
  { question: "유리창은 재활용이 가능한가요?", answer: "불가능" },
  { question: "계란판은 어떤 경우에만 재활용되나요?", answer: "깨끗할 때" },
  { question: "플라스틱 뚜껑은 어떻게 버리나요?", answer: "플라스틱류" },
